...
from iftool.misc import random_hash
from iftool.misc import print_warning
from iftool.misc import fix_float_to_length
from iftool.misc import get_latest_workspace
from iftool.misc import prepare_workspace_from
...
def run_accelerate(
    ...
    **kwargs: Any,
    ...
    tmp_path = _rewrite(
        path,
        f"""
from iflearn.misc.toolkit import _set_environ_workspace
...
import os
from iflearn.misc.toolkit import _set_environ_workspace
from iflearn.dist.ml.runs._utils import get_info
