...
from iftool.cv import to_rgb
from iftool.cv import to_uint8
from iftool.cv import read_image
from iftool.cv import save_images
from iftool.cv import restrict_wh
from iftool.cv import get_suitable_size
from iftool.cv import ReadImageResponse
from iftool.misc import safe_execute
from iftool.misc import print_warning
from iftool.misc import shallow_copy_dict
from iftool.types import arr_type
from iftool.types import tensor_dict_type
from safetensors.torch import load_file
from iflearn.misc.toolkit import _get_file_size
...
def _convert_external(m: "DiffusionAPI", tag: str, sub_folder: Optional[str]) -> str:
    ...
    with lock:
        ...
        if f_size is None or v_size != f_size:
            ...
            d = iflearn.scripts.sd.convert(model_path, m, load=False)
