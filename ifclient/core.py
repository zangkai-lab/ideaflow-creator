...
"""
这个模块主要用于处理 C 语言中的结构体类型的数据，
它可以将 Python 数据类型（如整数、浮点数、字符串等）转换为 C 结构体类型的二进制数据，
也可以将 C 结构体类型的二进制数据转换为 Python 数据类型
"""
...
"""
aiohttp 是一个用于异步 HTTP 网络请求的 Python 库。
它使用 Python 的 asyncio 库来实现并发，并且支持 HTTP 客户端和服务器功能。
"""
